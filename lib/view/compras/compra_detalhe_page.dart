...
class CompraDetalhePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var content = Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Expanded(child: ListView.builder(physics: BouncingScrollPhysics(), shrinkWrap: true, itemCount: 8, itemBuilder: (BuildContext context, int i){
              return Container(
    ...
    return Layout.render(context, Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        Padding(padding: EdgeInsets.only(left: 20,bottom: 0),
        child: Text('Compra #$id', style: Theme.of(context).textTheme.titleLarge?.copyWith(color: Layout.light()),),),
